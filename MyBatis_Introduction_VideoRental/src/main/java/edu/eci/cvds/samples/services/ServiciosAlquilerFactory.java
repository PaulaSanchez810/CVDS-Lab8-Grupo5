...
public class ServiciosAlquilerFactory {
    ...
    private Injector myBatisInjector(String env, String pathResource) {
        return createInjector(new XMLMyBatisModule() {
            ...
            protected void initialize() {
                ...
                bind(ServiciosAlquier.class).to(ServiciosAlquilerImpl.class);
            }
        });
    }
    ...
    public ServiciosAlquier getServiciosAlquiler(){
        if (!optInjector.isPresent()) {
            optInjector = Optional.of(myBatisInjector("development","mybatis-config.xml"));
        }

        return optInjector.get().getInstance(ServiciosAlquier.class);
    }


    public ServiciosAlquier getServiciosAlquilerTesting(){
        if (!optInjector.isPresent()) {
